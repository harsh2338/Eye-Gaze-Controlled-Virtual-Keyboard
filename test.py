...
class Eye():
    ...
    def generate_autocomplete_words(self):
        ...
        print(self.predicted_words)

    def check_wink(self, is_in_autocomplete_window, landmarks, prev_wink, wink_counter):
        ...
        if (eye_which_winked != None):
            ...
            if (eye_which_winked == Direction.RIGHT):
                ...
                if (wink_counter % constants.FPS == 0):
        ...
        return is_in_autocomplete_window, prev_wink, wink_counter, is_winking
    ...
    def algo(self):
        ...
        while True:
            ...
            if (is_in_autocomplete_window and len(self.text) > 0):
                self.keyboard.fill(255)
                ...
                if (self.is_blinking(landmarks)):
                    ...
                    if (blinking_counter == constants.FPS):
                        ...
                        if (self.keyboard_contents[highlight_index] == '123'):
                            ...
                            frame_counter = 1
                        # self.update_autocomplete_window()
            ...
            is_in_autocomplete_window, prev_wink, wink_counter, is_winking = self.check_wink(is_in_autocomplete_window,
                                                                                             landmarks, prev_wink,
                                                                                             wink_counter)
